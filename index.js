...
module.exports = async (req, res) => {
  if (req.method === 'POST') {
    ...
    if (message) {
      ...
      // Use OpenAI to get a response (simplified, you'll need the full prompt here)
      try {
        const aiResponse = await axios.post('https://api.openai.com', {
            model: "gpt-4", // Use gpt-3.5-turbo if you prefer a cheaper model
            messages: [
        ...
        await sendMessage(chat_id, "Desculpe, tive um problema ao processar sua solicitação.");
      }
